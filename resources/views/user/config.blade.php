    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('user.update')}}" aria-label="Configuración de mi cuenta" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="nick" class="col-md-4 col-form-label text-md-right">{{ __('Alias') }}</label>
                        ...
                        <div class="form-group row">
                            @if (Auth::user()->image)
                                <div class="avatar">
                                    <img class="rounded mx-auto d-block" src="{{ route('user.avatar', ['filename'=>Auth::user()->image]) }}" alt="">
                                </div>
                            @endif
                        </div>
                        <div class="form-group row">
